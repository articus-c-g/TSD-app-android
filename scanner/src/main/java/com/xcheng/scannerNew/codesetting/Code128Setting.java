...
public class Code128Setting extends BaseSetting {

    private static final String TAG = "Code128Setting";

    private static final String COMMAND_MAX_LENGTH = "909002";
    private static final String COMMAND_MIN_LENGTH = "909003";

    private static final String KEY_MIN = "code128_min";
    private static final String KEY_MAX = "code128_max";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMaxPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMaxLengthDialog(Code128Setting.this, preference, maxTitle,
        ...
        mMinPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMinLengthDialog(Code128Setting.this, preference, minTitle,
