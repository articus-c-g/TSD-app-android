...
public class Code93Setting extends BaseSetting {

    private static final String TAG = "Code93Setting";

    private static final String COMMAND_MAX_LENGTH = "904003";
    private static final String COMMAND_MIN_LENGTH = "904004";

    private static final String KEY_MIN = "code93_min";
    private static final String KEY_MAX = "code93_max";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMaxPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMaxLengthDialog(Code93Setting.this, preference, maxTitle,
        ...
        mMinPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMinLengthDialog(Code93Setting.this, preference, minTitle,
