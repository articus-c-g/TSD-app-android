...
public class Straight2of5Setting extends BaseSetting {

    private static final String TAG = "Straight2of5Setting";

    private static final String COMMAND_MAX_LENGTH = "905002";
    private static final String COMMAND_MIN_LENGTH = "905003";

    private static final String KEY_MIN = "Straight2of5_min";
    private static final String KEY_MAX = "Straight2of5_max";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMaxPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMaxLengthDialog(Straight2of5Setting.this, preference, maxTitle,
        ...
        mMinPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMinLengthDialog(Straight2of5Setting.this, preference, minTitle,
