...
public class Gs1ExpandedSetting extends BaseSetting {

    private static final String TAG = "Gs1ExpandedSetting";

    private static final String COMMAND_MAX_LENGTH = "920002";
    private static final String COMMAND_MIN_LENGTH = "920003";

    private static final String KEY_MIN = "Gs1Expanded_min";
    private static final String KEY_MAX = "Gs1Expanded_max";

    private static final int MAX_LENGTH = 74;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMaxPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMaxLengthDialog(Gs1ExpandedSetting.this, preference, maxTitle,
        ...
        mMinPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMinLengthDialog(Gs1ExpandedSetting.this, preference, minTitle,
