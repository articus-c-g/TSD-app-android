...
public class CodeBlockFSetting extends BaseSetting {

    private static final String TAG = "CodeBlockFSetting";

    private static final String COMMAND_MAX_LENGTH = "923002";
    private static final String COMMAND_MIN_LENGTH = "923003";

    private static final String KEY_MIN = "codeblockf_min";
    private static final String KEY_MAX = "codeblockf_max";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMaxPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMaxLengthDialog(CodeBlockFSetting.this, preference, maxTitle,
        ...
        mMinPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMinLengthDialog(CodeBlockFSetting.this, preference, minTitle,
