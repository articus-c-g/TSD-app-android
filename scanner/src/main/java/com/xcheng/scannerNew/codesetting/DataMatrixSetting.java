...
public class DataMatrixSetting extends BaseSetting {

    private static final String TAG = "DataMatrixSetting";

    private static final String COMMAND_MAX_LENGTH = "929002";
    private static final String COMMAND_MIN_LENGTH = "929003";

    private static final String KEY_MIN = "datamatrix_min";
    private static final String KEY_MAX = "datamatrix_max";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMaxPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMaxLengthDialog(DataMatrixSetting.this, preference, maxTitle,
        ...
        mMinPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMinLengthDialog(DataMatrixSetting.this, preference, minTitle,
