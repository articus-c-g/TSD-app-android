...
public class HanXinSetting extends BaseSetting {

    private static final String TAG = "HanXinSetting";

    private static final String COMMAND_MAX_LENGTH = "932002";
    private static final String COMMAND_MIN_LENGTH = "932003";

    private static final String KEY_MIN = "HanXin_min";
    private static final String KEY_MAX = "HanXin_max";

    private static final int MAX_LENGTH = 7833;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMaxPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMaxLengthDialog(HanXinSetting.this, preference, maxTitle,
        ...
        mMinPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMinLengthDialog(HanXinSetting.this, preference, minTitle,
