...
public class Pdf417Setting extends BaseSetting {

    private static final String TAG = "Pdf417Setting";

    private static final String COMMAND_MAX_LENGTH = "924002";
    private static final String COMMAND_MIN_LENGTH = "924003";

    private static final String KEY_MIN = "Pdf417_min";
    private static final String KEY_MAX = "Pdf417_max";

    private static final int MAX_LENGTH = 2750;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMaxPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMaxLengthDialog(Pdf417Setting.this, preference, maxTitle,
        ...
        mMinPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMinLengthDialog(Pdf417Setting.this, preference, minTitle,
