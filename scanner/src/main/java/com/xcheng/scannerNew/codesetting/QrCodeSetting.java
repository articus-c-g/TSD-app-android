...
public class QrCodeSetting extends BaseSetting {

    private static final String TAG = "QrCodeSetting";

    private static final String COMMAND_MAX_LENGTH = "928002";
    private static final String COMMAND_MIN_LENGTH = "928003";

    private static final String KEY_MIN = "QrCode_min";
    private static final String KEY_MAX = "QrCode_max";

    private static final int MAX_LENGTH = 7089;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMaxPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMaxLengthDialog(QrCodeSetting.this, preference, maxTitle,
        ...
        mMinPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMinLengthDialog(QrCodeSetting.this, preference, minTitle,
