...
public class MaxiCodeSetting extends BaseSetting {

    private static final String TAG = "MaxiCodeSetting";

    private static final String COMMAND_MAX_LENGTH = "907002";
    private static final String COMMAND_MIN_LENGTH = "907003";

    private static final String KEY_MIN = "MaxiCode_min";
    private static final String KEY_MAX = "MaxiCode_max";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMaxPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMaxLengthDialog(MaxiCodeSetting.this, preference, maxTitle,
        ...
        mMinPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMinLengthDialog(MaxiCodeSetting.this, preference, minTitle,
