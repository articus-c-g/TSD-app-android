...
public class Matrix2of5Setting extends BaseSetting {

    private static final String TAG = "Matrix2of5Setting";

    private static final String COMMAND_MAX_LENGTH = "907002";
    private static final String COMMAND_MIN_LENGTH = "907003";

    private static final String KEY_MIN = "Matrix2of5_min";
    private static final String KEY_MAX = "Matrix2of5_max";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMaxPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMaxLengthDialog(Matrix2of5Setting.this, preference, maxTitle,
        ...
        mMinPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMinLengthDialog(Matrix2of5Setting.this, preference, minTitle,
