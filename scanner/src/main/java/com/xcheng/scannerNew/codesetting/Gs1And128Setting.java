...
public class Gs1And128Setting extends BaseSetting {

    private static final String TAG = "Gs1And128Setting";

    private static final String COMMAND_MAX_LENGTH = "910002";
    private static final String COMMAND_MIN_LENGTH = "910003";

    private static final String KEY_MIN = "Gs1And128_min";
    private static final String KEY_MAX = "Gs1And128_max";

    private static final int MAX_LENGTH = 80;
    private static final int MIN_LENGTH = 0;
    private static final int DFAULT_MIN_LENGTH = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMaxPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMaxLengthDialog(Gs1And128Setting.this, preference, maxTitle,
        ...
        mMinPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMinLengthDialog(Gs1And128Setting.this, preference, minTitle,
