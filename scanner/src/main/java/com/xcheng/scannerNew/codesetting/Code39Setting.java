...
public class Code39Setting extends BaseSetting {

    private static final String TAG = "Code39Setting";

    private static final String COMMAND_CHAR_SETTING = "901009";
    private static final String COMMAND_CHECK_CHAR = "901004";
    private static final String COMMAND_MAX_LENGTH = "901007";
    private static final String COMMAND_MIN_LENGTH = "901008";

    private static final String KEY_CHECKBOX = "code39_checkbox";
    private static final String KEY_CHAR = "code39_char";
    private static final String KEY_MIN = "code39_min";
    private static final String KEY_MAX = "code39_max";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCharSettingPref.setChecked(BaseSetting.getSharedPreferences(Code39Setting.this).getInt(KEY_CHECKBOX, -1) == 1);
        mCharSettingPref.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
            @Override
            public boolean onPreferenceChange(Preference preference, Object objValue) {
                boolean checked = (Boolean) objValue;
                Editor editor = BaseSetting.getSharedPreferences(Code39Setting.this).edit();
        ...
        int char_value = BaseSetting.getSharedPreferences(Code39Setting.this).getInt(KEY_CHAR, -1);
        if (char_value != -1){
        ...
        int maxValue = BaseSetting.getSharedPreferences(Code39Setting.this).getInt(KEY_MAX, -1);
        if (maxValue != -1){
        ...
        mMaxPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMaxLengthDialog(Code39Setting.this, preference, maxTitle,
        ...
        int minValue = BaseSetting.getSharedPreferences(Code39Setting.this).getInt(KEY_MIN, -1);
        if (minValue != -1){
        ...
        mMinPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMinLengthDialog(Code39Setting.this, preference, minTitle,
