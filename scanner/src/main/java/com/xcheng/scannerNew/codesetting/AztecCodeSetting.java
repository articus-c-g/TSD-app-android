...
public class AztecCodeSetting extends BaseSetting {

    private static final String TAG = "AztecCodeSetting";

    private static final String COMMAND_MAX_LENGTH = "931002";
    private static final String COMMAND_MIN_LENGTH = "931003";

    private static final String KEY_MIN = "AztecCode_min";
    private static final String KEY_MAX = "AztecCode_max";

    private static final int MAX_LENGTH = 3832;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMaxPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMaxLengthDialog(AztecCodeSetting.this, preference, maxTitle,
        ...
        mMinPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMinLengthDialog(AztecCodeSetting.this, preference, minTitle,
