...
public class Straight2of5IataSetting extends BaseSetting {

    private static final String TAG = "Straight2of5IataSetting";

    private static final String COMMAND_MAX_LENGTH = "906002";
    private static final String COMMAND_MIN_LENGTH = "906003";

    private static final String KEY_MIN = "Straight2of5Iata_min";
    private static final String KEY_MAX = "Straight2of5Iata_max";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMaxPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMaxLengthDialog(Straight2of5IataSetting.this, preference, maxTitle,
        ...
        mMinPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMinLengthDialog(Straight2of5IataSetting.this, preference, minTitle,
