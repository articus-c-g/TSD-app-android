...
public class TelepenSetting extends BaseSetting {

    private static final String TAG = "TelepenSetting";

    private static final String COMMAND_MAX_LENGTH = "910002";
    private static final String COMMAND_MIN_LENGTH = "910003";

    private static final String KEY_MIN = "Telepen_min";
    private static final String KEY_MAX = "Telepen_max";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMaxPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMaxLengthDialog(TelepenSetting.this, preference, maxTitle,
        ...
        mMinPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMinLengthDialog(TelepenSetting.this, preference, minTitle,
