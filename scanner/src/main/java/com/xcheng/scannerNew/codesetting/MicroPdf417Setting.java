...
public class MicroPdf417Setting extends BaseSetting {

    private static final String TAG = "MicroPdf417Setting";

    private static final String COMMAND_MAX_LENGTH = "925002";
    private static final String COMMAND_MIN_LENGTH = "925003";

    private static final String KEY_MIN = "MicroPdf417_min";
    private static final String KEY_MAX = "MicroPdf417_max";

    private static final int MAX_LENGTH = 366;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMaxPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMaxLengthDialog(MicroPdf417Setting.this, preference, maxTitle,
        ...
        mMinPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMinLengthDialog(MicroPdf417Setting.this, preference, minTitle,
