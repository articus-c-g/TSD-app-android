...
public class Interleaved2of5Setting extends BaseSetting {

    private static final String TAG = "Interleaved2of5Setting";

    private static final String COMMAND_CHAR_SETTING = "902001";
    private static final String COMMAND_MAX_LENGTH = "902003";
    private static final String COMMAND_MIN_LENGTH = "902004";

    private static final String KEY_CHECKBOX = "Interleaved2of5_checkbox";
    private static final String KEY_MIN = "Interleaved2of5_min";
    private static final String KEY_MAX = "Interleaved2of5_max";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCharSettingPref.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
            ...
            public boolean onPreferenceChange(Preference preference, Object objValue) {
                ...
                Editor editor = BaseSetting.getSharedPreferences(Interleaved2of5Setting.this).edit();
        ...
        mMaxPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMaxLengthDialog(Interleaved2of5Setting.this, preference, maxTitle,
        ...
        mMinPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                createMinLengthDialog(Interleaved2of5Setting.this, preference, minTitle,
